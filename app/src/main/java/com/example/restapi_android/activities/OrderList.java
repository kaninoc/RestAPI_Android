...
public class OrderList extends AppCompatActivity {
    ...
    private String url = "https://www.datos.gov.co/resource/hk5x-635y.json?#order= municipio DESC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonTextView = findViewById(R.id.jsonOrderTextView);
            ...
            public void onResponse(JSONArray response) {
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        listaCompleta.append("COLEGIO: ").append(institucionEducativa).append("\n").append("MUNICIPIO: ").append(municipio).append("\n \n");
